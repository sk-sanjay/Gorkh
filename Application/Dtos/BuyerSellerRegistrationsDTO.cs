...
{
    public class BuyerSellerRegistrationsDTO
    {
        ...
        public virtual CountriesDTO Countries { get; set; }


        public virtual StatesDTO States { get; set; }
        public virtual OrganisationTypesDTO OrganisationTypes { get; set; }
