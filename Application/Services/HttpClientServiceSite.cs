...
{
    public class HttpClientServiceSite : IHttpClientService
    {
        private readonly IConfiguration _config;
        private readonly HttpClient _httpClient;
        private readonly IHttpContextAccessor _httpContextAccessor;
        private readonly INotyfService _notyf;
        public HttpClientServiceSite(
        ...
        private async Task<bool> AddAuthHeader()
        {
            ...
            var refreshtoken = _httpContextAccessor.HttpContext.Request.Cookies[".SURPS.RefreshToken"];
            ...
            var accesstoken = _httpContextAccessor.HttpContext.Request.Cookies[".SURPS.AuthToken"];
        ...
        private void UtilizeNewToken(TokenVM newTokenVm)
        {
            ...
            _httpContextAccessor.HttpContext.Response.Cookies.Append(".SURPS.AuthToken", newTokenVm.AccessToken, cookieOptions);
        }
