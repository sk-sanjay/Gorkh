    ...
    $.fn.extend({
        passwordRequirements: function (options) {
            ...
            return this.each(function () {
                ...
                o.infoMessage = 'The minimum password length is ' + o.numCharacters + ' characters and must contain at least 1 lower-case, 1 upper-case, 1 number and 1 special character.';
                ...
                var showMessage = function () {
                    ...
                    $('.pr-submit-btn').prop('disabled', true);
                };
                ...
                var deleteMessage = function () {
                    ...
                    $('.pr-submit-btn').prop('disabled', false);
                };
