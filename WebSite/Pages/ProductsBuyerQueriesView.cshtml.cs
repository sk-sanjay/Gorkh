...
namespace WebSite.Pages
{
    public class ProductsBuyerQueriesViewModel : PageModel
    {
        ...
        public ProductsBuyerQueriesViewModel(IHttpClientService httpClient, INotyfService notyf, IEmailService emailService)
        {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            var modelResponse = await _httpClient.GetAsync("ProductsBuyerQueries/GetProductsByBuyer", false, buyerid).ConfigureAwait(false);
