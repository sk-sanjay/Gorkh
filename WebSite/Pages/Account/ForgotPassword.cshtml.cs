...
namespace WebSite.Pages.Account
{
    ...
    public class ForgotPasswordModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            await _emailService.SendEmailAsync(forgotPasswordVm.Email, "Password Reset Link", Body, null, "surplusplatforms@gmail.com", null).ConfigureAwait(false);
            _notyf.Success("Please check your email to reset your password");
            return LocalRedirect("/Account/Seller-Login");
        }
    }
}