...
{
    public class BuyerPaymentsDetailsModel : PageModel
    {
        private readonly IHttpClientService _httpClient;
        private readonly INotyfService _notyf;
        public BuyerPaymentsDetailsModel(
        ...
        {
            var modelResponse = await _httpClient.GetAsync("Payments/GetPaymentsByProductIdForSeller", true, id).ConfigureAwait(false);
