try {
    ...
    $("#ManageModal").on("show.bs.modal",
        function (event) {
            var url = "/Admin/Masters/Banners/Index?handler=Model";
            ...
            if (typeof id != "undefined") {
                $.ajax({
                    ...
                    success: function (data) {
                        if (data != null) {
                            ...
                            $("#lblOldBannerImage").text(data.bannerImage);
                            $("#hdnOldBannerImage").val(data.bannerImage);
                ...
                $("#Title").val('');
                $("#Descriptions").val('');
                $("#lblOldBannerImage").text('');
                $("#hdnOldBannerImage").val('');
    ...
    function Delete(id) {
        getConfirm("Are you sure you want to delete?", function (result) {
            if (result) {
                $.ajax({
                    type: "GET",
                    url: "/Admin/Masters/Banners/Index?handler=Delete",
                    data: { id: id },
                    success: function (data) {
                        if (data != null) {
