try {
    ...
    $("#ManageModal").on("show.bs.modal",
        function (event) {
            var url = "/Admin/Masters/Specifications/Index?handler=Model";
            ...
            if (typeof id != "undefined") {
                $.ajax({
                    ...
                    success: function (data) {
                        if (data != null) {
                            $("#Id").val(data.id);
                            $("#SpecfName").val(data.specfName);
                            $("#TextType").val(data.textType);
                            $("#IsCommon").attr("checked", data.isCommon);
    ...
    function Delete(id) {
        getConfirm("Are you sure you want to delete?", function (result) {
            if (result) {
                $.ajax({
                    type: "GET",
                    url: "/Admin/Masters/Specifications/Index?handler=Delete",
                    data: { id: id },
                    success: function (data) {
                        if (data != null) {
