try {
    ...
    $("#ManageModal").on("show.bs.modal",
        function (event) {
            var url = "/Admin/Masters/VoltageFrequencies/Index?handler=Model";
            ...
            if (typeof id != "undefined") {
                $.ajax({
                    ...
                    success: function (data) {
                        if (data != null) {
                            $("#Id").val(data.id);
                            $("#VoltFrequency").val(data.voltFrequency);
    ...
    function Delete(id) {
        getConfirm("Are you sure you want to delete?", function (result) {
            if (result) {
                $.ajax({
                    type: "GET",
                    url: "/Admin/Masters/VoltageFrequencies/Index?handler=Delete",
                    data: { id: id },
                    success: function (data) {
                        if (data != null) {
