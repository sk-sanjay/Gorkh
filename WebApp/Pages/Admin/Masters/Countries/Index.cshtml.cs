...
namespace WebApp.Pages.Admin.Masters.Countries
{
    ...
    public class IndexModel : PageModel
    {
        ...
        {
            ModelDto = ModelAuditor<CountriesDTO>.SetAudit(User.Identity.Name, ModelDto.Id == 0 ? "Create" : "Edit", HttpContext.Connection.RemoteIpAddress.ToString(), ModelDto);
            ...
            ? await _httpClient.PostAsync("Countries/Create", true, ModelDto).ConfigureAwait(false)
            : await _httpClient.PutAsync("Countries/Edit", true, ModelDto.Id, ModelDto)
