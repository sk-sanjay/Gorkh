...
namespace WebApp.Pages.Admin.Products
{
    ...
    public class ProductsBuyerInterestsViewModel : PageModel
    {
        ...
        public ProductsBuyerInterestsViewModel(
        ...
        {
            var modelResponse = await _httpClient.GetAsync("ProductsBuyerIntrests/GetProductsBuyerIntrestsForAdmin", true).ConfigureAwait(false);
