...
namespace WebApp.Pages.Admin.RegisteredBuyersandSellers
{
    ...
    public class BuyerandSellerModel : PageModel
    {
        private readonly IHttpClientService _httpClient;
        private readonly INotyfService _notyf;

        public BuyerandSellerModel(
        ...
        {
            var modelResponse = await _httpClient.GetAsync("BuyerSellerRegistrations/GetBothData", true).ConfigureAwait(false);
